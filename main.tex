...
\item \textcolor{darkblue}{autodiff} (JAX, elementwise, reducers)
\item \textcolor{darkblue}{GPU support} (direct \& through Numba)
\end{itemize}
\end{frame}
...
This is {\it the visible part} of Pratyush Das \& Anish Biswas's hard work this summer!
...
\begin{uncoverenv}<3->
\begin{minted}{python}
>>> ak.num(on_gpu)                   # some operations work on GPU
...
\begin{uncoverenv}<5->
\begin{minted}{python}
>>> cp.asarray(ak.flatten(on_gpu))   # stays on GPU as a CuPy array
