...
Plateaued at a small fraction of pip-installs, but significant cross-over for ``\mintinline{python}{import awkward}'' vs.\ ``\mintinline{python}{import awkward1}'' in GitHub searches.
